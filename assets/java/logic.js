...
return to me when summoned.\nAfter all... WHAT IS A COLLECTOR WITHOUT HIS HOARD."',0,36)}; // Used with "<body onload="initialModal()">"" in HTML to display modal once the page loads
...
function modalDisplay(videoId,title,start,end,delay){
  ...
  Swal.fire({
    ...
    playerVars: {
      ...
      'end': end,
      'controls': 0,
      'showinfo' : 0, // Hides video title/info when video plays
